                ...
                <div class="row">
                    <div class="col-xl-12 mb-70 d-inline-flex factories">
                        <div class="col-lg-6 section-title">
                            <h1>Innovation Gateway: Get to know all DF's</h1>
                            <!-- <p>Kabupaten Bogor </p> -->
                        </div>
                        <div class="col-lg-6">
                            <p>
                                Each Design Factory is distinct, but dive into this section to learn more about our different Design Factories locations, and the organisation or institution they are part of. Here you'll discover brief introductions to each Design Factory, get insights into their unique focuses, signature projects, and most importantly, find contact details for those who can provide further information about each Design Factory. This gateway is your starting point for exploring the awesome diversity of our network.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row" id="s_nums">
                    <div class="col-xl-4 col-lg-4 col-md-5 mb-30">
                        <div class="df-numb-fc df" >
                            <div class="nums si counter" id="counter" data-target="29">
                                29
                            </div>
                            <div class="ic-title">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 mb-30">
                        <div class="df-numb-fc ctn">
                            <div class="nums ip counter" id="counter" data-target="25">
                                25
                            </div>
                            <div class="ic-title">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 mb-30">
                        <div class="df-numb-fc dfp">
                            <div class="nums ar counter" id="counter" data-target="160">
                                160
                            </div>
                            <div class="ic-title">
                    ...
                    <div class="col-xl-12 d-flex boxies">
                        ...
                        <div class="txt-right select-df">
                                    ...
                                    <!-- <select id="select-cronogical" name="pilihan" data-placeholder="Sort by: chronological">
                                        <option value="nilai1">Chronological</option>
                                        <option value="nilai2">A-Z</option>
                                    </select> -->
                        </div>
                    </div>
